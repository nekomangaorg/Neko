...
class ChapterPutResolver : DefaultPutResolver<Chapter>() {
    ...
    override fun mapToInsertQuery(obj: Chapter) = InsertQuery.builder().table(TABLE).build()
    ...
    override fun mapToContentValues(obj: Chapter) =
        ContentValues(11).apply {
            ...
            put(COL_UNAVAILABLE, obj.isUnavailable)
...
class ChapterGetResolver : DefaultGetResolver<Chapter>() {
    ...
    override fun mapFromCursor(cursor: Cursor): Chapter =
        ChapterImpl().apply {
            ...
            old_mangadex_id =
                cursor.getStringOrNull(cursor.getColumnIndex(COL_OLD_MANGADEX_CHAPTER_ID))
        }
}
