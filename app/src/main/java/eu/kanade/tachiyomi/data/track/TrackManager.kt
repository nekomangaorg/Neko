...
class TrackManager(context: Context) {
    ...
    val services = hashMapOf<Int, TrackService>(mdList.id to mdList, myAnimeList.id to myAnimeList, aniList.id to aniList, kitsu.id to kitsu, mangaUpdates.id to mangaUpdates)
