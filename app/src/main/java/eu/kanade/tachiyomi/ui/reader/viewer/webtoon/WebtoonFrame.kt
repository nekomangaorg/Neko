...
/**
 * Frame layout which contains a [WebtoonRecyclerView]. It's needed to handle touch events, because
 * the recyclerview is scaled and its touch events are translated, which breaks the detectors.
 *
