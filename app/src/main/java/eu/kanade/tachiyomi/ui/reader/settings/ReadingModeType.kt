...
enum class ReadingModeType(
    ...
    PAGED_VERTICAL(3, R.string.vertical_paged_viewer, R.drawable.ic_reader_vertical_24dp),
    WEBTOON(4, R.string.webtoon, R.drawable.ic_reader_webtoon_24dp),
    VERTICAL(5, R.string.vertical_gaps_viewer, R.drawable.ic_reader_webtoon_24dp);
    ...
    companion object {
        ...
        fun isPagerType(preference: Int): Boolean {
            ...
            return mode == LEFT_TO_RIGHT || mode == RIGHT_TO_LEFT || mode == PAGED_VERTICAL
        }

        fun isWebtoonType(preference: Int): Boolean {
            val mode = fromPreference(preference)
            return mode == WEBTOON || mode == VERTICAL
        }
