...
// =========================================================================
    // LEGACY UPSERT RESOLVER MIGRATION
    // =========================================================================

    @Query("SELECT * FROM history WHERE history_chapter_id = :chapterId")
    suspend fun getHistoryByChapterId(chapterId: Long): HistoryEntity?

    @Insert(onConflict = OnConflictStrategy.IGNORE)
    suspend fun insertHistory(history: HistoryEntity): Long

    @Query("UPDATE history SET history_last_read = :lastRead, history_time_read = :timeRead WHERE history_chapter_id = :chapterId")
