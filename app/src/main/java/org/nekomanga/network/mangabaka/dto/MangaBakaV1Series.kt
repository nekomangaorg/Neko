...
data class MangaBakaV1Series(
    ...
    @SerialName("secondary_titles") val secondaryTitles: Map<String, List<MangaBakaSecondaryTitle>>? = null,
    ...
    @Deprecated("The year publication began for the series")
    ...
    @Deprecated("Use genres_v2 instead")
