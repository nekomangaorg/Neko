...
fun NekoTopAppBar(
    ...
    when (type) {
        ...
        NekoTopAppBarType.TitleAndSubtitle ->
        ...
        NekoTopAppBarType.SearchOutline ->
            SearchOutlineTopAppBar(
                onSearchText = onSearch,
                searchPlaceHolder = searchPlaceholder,
                color = color,
                navigationEnabled = !isRoot,
                navigationIconLabel = navigationIconLabel,
                navigationIcon = navigationIcon,
                focusRequester = focusRequester,
                onNavigationIconClicked = onNavigationIconClicked,
        ...
        NekoTopAppBarType.SearchOutlineDummy ->
        ...
        NekoTopAppBarType.SearchOutlineWithActions ->
...
private fun TitleAndSubtitleTopAppBar(
    ...
    FlexibleTopBar(
        scrollBehavior = scrollBehavior,
        colors =
            FlexibleTopBarColors(containerColor = color, scrolledContainerColor = color),
    ) {
        Box(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Column(modifier = Modifier
                ...
                AutoSizeText(text = title, style = MaterialTheme.typography.titleLarge, textAlign = TextAlign.Center)
                if (subtitle.isNotEmpty()) {
                    AutoSizeText(text = subtitle, style = MaterialTheme.typography.titleMedium, textAlign = TextAlign.Center)
                }
            }
...
@Composable
private fun SearchOutlineTopAppBar(
    onSearchText: (String?) -> Unit,
    searchPlaceHolder: String,
    color: Color,
...
@Composable
private fun SearchOutlineWithActionsTopAppBar(
    onSearchText: (String?) -> Unit,
    searchPlaceHolder: String,
    searchPlaceHolderAlt: String,
    color: Color,
...
@Composable
private fun SearchOutlineDummyTopAppBar(
    onSearchEnabled: () -> Unit,
    searchPlaceHolder: String,
    color: Color,
    navigationEnabled: Boolean,
