                        ...
                        snapshotFlow {
                            ...
                            .collectLatest {
                                if (
                                    ...
                                    val proportion =
                                        1f -
                                            remainingSectionsLocal / maxRemainingSectionsState.value
                                    thumbOffsetY =
                                        trackHeightPxState.value * proportion +
                                            thumbTopPaddingState.value
                                    if (stableScrollInProgressState.value) scrolled.tryEmit(Unit)
                                }
                            }
                    }
