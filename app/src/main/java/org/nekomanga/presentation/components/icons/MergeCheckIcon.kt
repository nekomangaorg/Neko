            ...
            ImageVector.Builder(
                ...
                .apply {
                    path(fill = SolidColor(Color.Black)) {
                        ...
                        curveTo(8.66f, 2f, 10f, 3.34f, 10f, 5f)
