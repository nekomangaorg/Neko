...
internal object TakoColorScheme : BaseColorScheme() {
    override val lightScheme =
        lightColorScheme(
            ...
            secondaryContainer =
                Color(0xFFC8BED0), // Navigation bar selector pill & progress indicator (remaining)
    ...
    override val darkScheme =
        darkColorScheme(
            ...
            secondaryContainer =
                Color(0xFF5C4D4B), // Navigation bar selector pill & progress indicator (remaining)
