...
/**
 * Based on
 * https://github.com/square/okhttp/blob/ef5d0c83f7bbd3a0c0534e7ca23cbc4ee7550f3b/okhttp-dnsoverhttps/src/test/java/okhttp3/dnsoverhttps/DohProviders.java
 */
 ...
 */
fun OkHttpClient.Builder.dohMullvad() =
    dns(
        DnsOverHttps.Builder()
            .client(build())
 ...
 */
fun OkHttpClient.Builder.dohControlD() =
    dns(
        DnsOverHttps.Builder()
            .client(build())
...
fun OkHttpClient.Builder.dohShecan() =
    dns(
        DnsOverHttps.Builder()
            .client(build())
